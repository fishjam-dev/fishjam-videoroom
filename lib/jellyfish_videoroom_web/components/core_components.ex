defmodule JellyfishVideoroomWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JellyfishVideoroomWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JellyfishVideoroomWeb.Gettext, "errors", msg, opts)
    end
  end
