defmodule JellyfishVideoroom.DataCase do
  @moduledoc """
  ...
  by setting `use JellyfishVideoroom.DataCase, async: true`, although
  ...
  using do
    quote do
      alias JellyfishVideoroom.Repo

      import Ecto
      import Ecto.Changeset
      import Ecto.Query
      import JellyfishVideoroom.DataCase
    end
  end
